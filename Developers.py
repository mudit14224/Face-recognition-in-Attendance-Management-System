...
def app():
    ...
    st.markdown("<h1 style='text-align: center; color: black;'>Meet Our Developers</h1>", unsafe_allow_html=True)
    # s2.title('Meet Our Developers')
    st.markdown("""
        <style>
        .dev-font {
            text-align: center ;
    ...
    c1.image("Images/jigglypuff7.png")
    # c1.markdown('<p class="big-font">Mahima</p>', unsafe_allow_html=True)
