...
def run():
    ...
    frame1.place(relx=0.20, rely=0.08, relwidth=0.63, relheight=0.85)
    ...
    message = tkinter.Label(frame1, text="" ,bg="white" ,fg="black"  ,width=39,height=1, activebackground = "blue" ,font=('times', 16, ' bold '))
    ...
    clearButton = tkinter.Button(frame1, text="Clear", command=clear, fg="white", bg="black", width=11, activebackground = "white", font=('times', 12, ' bold '))
    clearButton.place(x=55, y=230,relwidth=0.29)

    takeImg = tkinter.Button(frame1, text="Take Images", command=TakeImages, fg="black", bg="#f53b57", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
    takeImg.place(x=30, y=350,relwidth=0.89)

    trainImg = tkinter.Button(frame1, text="Save Profile", command=psw, fg="black", bg="#f53b57", width=34, height=1, activebackground = "white", font=('times', 16, ' bold '))
    trainImg.place(x=30, y=400,relwidth=0.89)

    quitWindow = tkinter.Button(frame1, text="Quit", command=window.destroy, fg="white", bg="black", width=35, height=1, activebackground = "white", font=('times', 16, ' bold '))
